...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    ...
    <h1 class="text-indigo-600 font-bold text-xl">Register:</h1>
        ...
        <p class="text-center text-sm text-gray-600">
            Already have an account? <a href="login.php" class="text-indigo-600 hover:text-indigo-500 font-medium">Log in here</a>
        </p>
    </div>
</div>
